...
impl Default for crate::EnemySpawnTimer {
    fn default() -> crate::EnemySpawnTimer {
        crate::EnemySpawnTimer {timer: Timer::from_seconds(STAR_SPAWN_TIME, TimerMode::Repeating)}
    }
}
